      ...
      <div className="bg-[#0a0a0a] border-b border-[#FFD700]/10 text-white text-[10px] py-1.5 px-4 hidden md:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex gap-4">
            <span><strong className="text-[#FFD700] uppercase">Contacto:</strong> contacto@yanapuma.com</span>
            <span className="w-[1px] h-3 bg-zinc-800"></span>
            <span><strong className="text-[#FFD700] uppercase">Ubicación:</strong> Iquitos, Loreto, Perú</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => setShowFullRoster(false)}>
              <img src={logoImg} alt="Yanapuma FC Logo" className="w-9 h-9 object-contain drop-shadow-[0_0_8px_rgba(255,215,0,0.25)] hover:scale-105 transition-transform" />
